...
import { fetchDiaryDetails, createDiary, updateDiary, CreateDiaryRequest, UpdateDiaryRequest, DiaryDetail } from '../services/diaryApi';
import { EmotionAnalysisModal } from './EmotionAnalysisModal';
...
export function DiaryWritingPage({ selectedDate, onFinish, onCancel }: DiaryWritingPageProps) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Show emotion analysis result modal
      setEmotionResult({
